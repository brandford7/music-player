...
const MusicCard = ({ title }) => {
  return (
    <div className=" flex flex-col items-center mx-auto space-y-5 p-5 max-w-md rounded-md hover:shadow-emerald-200 h-40 w-4/5 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
