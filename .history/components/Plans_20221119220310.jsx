    ...
    <div>
      ...
      <section className="flex space-x-20">
        ...
        <div className="space-y-5">
          ...
          <button className=" flex justify-center p-5 transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 ">
            Choose Plan
          </button>
        </div>
      </section>
